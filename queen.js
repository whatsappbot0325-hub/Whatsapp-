...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("dilamd~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🧚‍♂️ 𝐃𝐈𝐋𝐀-𝐌𝐃 is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **𝐃𝐈𝐋𝐀-𝐌𝐃 🎊️ Connected Successfully!** ✅ 
          
          --- **🎊️ Welcome to 𝐃𝐈𝐋𝐀-𝐌𝐃 🔥!** 🎊️ 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94764579803@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363417599449006@newsletter",
            newsletterName: "𝐃𝐈𝐋𝐀-𝐌𝐃🧚‍♂️",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "𝐃𝐈𝐋𝐀-𝐌𝐃🧚‍♂️",
            body: " ©𝐌𝐑 ᎠᏆᏞᎪᏦՏᎻᎪ ᏢᎡᎪᏴᎪͲᎻ 🔥",
            mediaType: 1,
            sourceUrl: "yt",
            thumbnailUrl:
              "https://github.com/whatsappbot0325-hub/myImage/blob/main/Flux_Dev_A_vertical_split_poster_featuring_Naruto_Uzumaki_from_3.jpg", // This should match the image URL provided above
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, 𝐃𝐈𝐋𝐀-𝐌𝐃 Is started✅");
});
app.listen(port, () =>
